...
- [openshift local setup (pre-requisite for the bpfman-operator demo (WIP))](RHEL9-OpenShift-Setup-README.md)
- Generic BTF (BPF Type Format) to OTEL mapper (In Progress)
